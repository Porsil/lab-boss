...
urlpatterns = [
     ...
     path('all_scheduler', views.AllWorkloadList.as_view(),
          name='all_scheduler'),
     ...
     path('all_workload/<pk>/delete/', views.AllDeleteWorkload.as_view(),
          name='all_delete_workload'),
     path('toggle_workload/<pk>', views.ToggleWorkload.as_view(),
          name='toggle_workload'),
     path('all_toggle_workload/<pk>', views.AllToggleWorkload.as_view(),
          name='all_toggle_workload'),
